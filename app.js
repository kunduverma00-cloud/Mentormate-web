...
function checkInToRoutine(routineId) {
    ...
    if (minutesLate < 5) {
        ...
        punishmentAssigned = '2 Min Mulgi + 5 Scale naked 🤭';
        punishmentMessage = '⚖️ Punishment: 2 Min Mulgi + 5 Scale naked 🤭(10+ minutes late)';
    } else if (minutesLate >= 20 && minutesLate < 30) {
        // 20MIN = Heavy Punishment
        punishmentAssigned = 'new punishment 🤭pose';
        punishmentMessage = '⚖️ Punishment: new punishment 🤭pose (20+ minutes late)';
